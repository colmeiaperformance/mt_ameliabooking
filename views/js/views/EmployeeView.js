                    ...
                    <div class="col-12 col-lg-7 instrutor-bio">
                        ...
                        <div class="containerButtons">
                            <div class="text-center div-button-whatsapp">
                                <a target="_blank" href="https://api.whatsapp.com/send?phone=${model.phone}&text=Ol%C3%A1,%20acessei%20seu%20contato%20no%20site%20da%20MT%20e%20gostaria%20de%20saber%20mais%20sobre%20o%20curso." class="btn btn-whatsapp"> 
                    ...
                    <div class="col-12 col-lg-7 mt-4 mt-lg-0 m-auto">
                        ...
                        <form id="employee-send-contact" onsubmit="sendContactForm(event,this)">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 form-group">
                                    <input type="tel" name="phone" class="form-control phoneMask" id="contactPhoneMsg" aria-describedby="phoneHelp" placeholder="DDD + Telefone" data-bs-toggle="tooltip" data-bs-placement="top" title="(00) 00000-0000">
                                </div>
                            </div>
                            <div class="row">
