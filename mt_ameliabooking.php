...
function add_plugins_and_scripts(){
   ...
   wp_register_script('add-intl-tel-input-utils-js', plugin_dir_url(__FILE__).'views/js/util/intl-tel-input/js/utils.js', '', null, '');
   ...
   wp_enqueue_script('add-intl-tel-input-utils-js');
